...
extern "C" CEF_EXPORT int cef_get_min_log_level() { 
    return 0;
}

extern "C" CEF_EXPORT cef_platform_thread_handle_t cef_get_current_platform_thread_handle() {
    return (cef_platform_thread_handle_t)::GetCurrentThread();
}

extern "C" CEF_EXPORT void cef_log(const char* file, int line, int severity, const char* message) {
    ;
}

extern "C" CEF_EXPORT cef_platform_thread_id_t cef_get_current_platform_thread_id() {
...
extern "C" CEF_EXPORT void cef_string_map_size() { DebugBreak(); }
extern "C" CEF_EXPORT void cef_string_map_key() { DebugBreak(); }
extern "C" CEF_EXPORT void cef_string_map_value() { DebugBreak(); }
extern "C" CEF_EXPORT void cef_string_map_append() { DebugBreak(); }
extern "C" CEF_EXPORT void cef_string_map_clear() { DebugBreak(); }
extern "C" CEF_EXPORT void cef_string_map_alloc() { DebugBreak(); }
extern "C" CEF_EXPORT void cef_string_map_free() { DebugBreak(); }
// CEF_EXPORT void cef_string_multimap_size() { DebugBreak(); }
// CEF_EXPORT void cef_string_multimap_key() { DebugBreak(); }
// CEF_EXPORT void cef_string_multimap_value() { DebugBreak(); }
// CEF_EXPORT void cef_string_multimap_append() { DebugBreak(); }
