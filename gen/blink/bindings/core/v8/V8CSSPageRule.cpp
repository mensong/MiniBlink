...
#endif
const WrapperTypeInfo V8CSSPageRule::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSPageRule::domTemplate, V8CSSPageRule::refObject, V8CSSPageRule::derefObject, V8CSSPageRule::trace, 0, 0, V8CSSPageRule::preparePrototypeObject, V8CSSPageRule::installConditionallyEnabledProperties, "CSSPageRule", &V8CSSRule::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static const V8DOMConfiguration::AccessorConfiguration V8CSSPageRuleAccessors[] = {
    {"selectorText", CSSPageRuleV8Internal::selectorTextAttributeGetterCallback, CSSPageRuleV8Internal::selectorTextAttributeSetterCallback, 0, 0, 0, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"style", CSSPageRuleV8Internal::styleAttributeGetterCallback, 0, 0, 0, 0, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

static void installV8CSSPageRuleTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "CSSPageRule", V8CSSRule::domTemplate(isolate), V8CSSPageRule::internalFieldCount,
        0, 0,
        V8CSSPageRuleAccessors, WTF_ARRAY_LENGTH(V8CSSPageRuleAccessors),
        0, 0);
...
v8::Local<v8::FunctionTemplate> V8CSSPageRule::domTemplate(v8::Isolate* isolate)
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8CSSPageRuleTemplate);
}
...
void V8CSSPageRule::refObject(ScriptWrappable* scriptWrappable)
{
#if !ENABLE(OILPAN)
    scriptWrappable->toImpl<CSSPageRule>()->ref();
#endif
}

void V8CSSPageRule::derefObject(ScriptWrappable* scriptWrappable)
{
#if !ENABLE(OILPAN)
    scriptWrappable->toImpl<CSSPageRule>()->deref();
#endif
}
