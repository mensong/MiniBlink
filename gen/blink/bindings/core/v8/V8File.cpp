...
namespace v8 {
extern DWORD isCreatingDataPropertyNow;
}
#endif
...
#if V8_MINOR_VERSION == 7
	//Gergul: 注释掉一行加三行
    //v8::isCreatingDataPropertyNow = true;
	if (0 == v8::isCreatingDataPropertyNow)
		v8::isCreatingDataPropertyNow = TlsAlloc();
	TlsSetValue(v8::isCreatingDataPropertyNow, (LPVOID)1);
#endif
...
#if V8_MINOR_VERSION == 7
	//Gergul: 注释掉一行加一行
    //v8::isCreatingDataPropertyNow = false;
	TlsSetValue(v8::isCreatingDataPropertyNow, (LPVOID)0);
#endif
}
