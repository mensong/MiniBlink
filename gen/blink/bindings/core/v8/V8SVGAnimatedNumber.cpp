...
#endif
const WrapperTypeInfo V8SVGAnimatedNumber::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGAnimatedNumber::domTemplate, V8SVGAnimatedNumber::refObject, V8SVGAnimatedNumber::derefObject, V8SVGAnimatedNumber::trace, 0, V8SVGAnimatedNumber::visitDOMWrapper, V8SVGAnimatedNumber::preparePrototypeObject, V8SVGAnimatedNumber::installConditionallyEnabledProperties, "SVGAnimatedNumber", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static const V8DOMConfiguration::AccessorConfiguration V8SVGAnimatedNumberAccessors[] = {
    {"baseVal", SVGAnimatedNumberV8Internal::baseValAttributeGetterCallback, SVGAnimatedNumberV8Internal::baseValAttributeSetterCallback, 0, 0, 0, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animVal", SVGAnimatedNumberV8Internal::animValAttributeGetterCallback, 0, 0, 0, 0, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

static void installV8SVGAnimatedNumberTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    if (!RuntimeEnabledFeatures::svg1DOMEnabled())
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGAnimatedNumber", v8::Local<v8::FunctionTemplate>(), V8SVGAnimatedNumber::internalFieldCount, 0, 0, 0, 0, 0, 0);
    else
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGAnimatedNumber", v8::Local<v8::FunctionTemplate>(), V8SVGAnimatedNumber::internalFieldCount,
            0, 0,
            V8SVGAnimatedNumberAccessors, WTF_ARRAY_LENGTH(V8SVGAnimatedNumberAccessors),
            0, 0);
...
v8::Local<v8::FunctionTemplate> V8SVGAnimatedNumber::domTemplate(v8::Isolate* isolate)
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8SVGAnimatedNumberTemplate);
}
...
void V8SVGAnimatedNumber::refObject(ScriptWrappable* scriptWrappable)
{
#if !ENABLE(OILPAN)
    scriptWrappable->toImpl<SVGAnimatedNumber>()->ref();
#endif
}

void V8SVGAnimatedNumber::derefObject(ScriptWrappable* scriptWrappable)
{
#if !ENABLE(OILPAN)
    scriptWrappable->toImpl<SVGAnimatedNumber>()->deref();
#endif
}
