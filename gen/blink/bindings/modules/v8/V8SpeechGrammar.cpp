...
#endif
const WrapperTypeInfo V8SpeechGrammar::wrapperTypeInfo = { gin::kEmbedderBlink, V8SpeechGrammar::domTemplate, V8SpeechGrammar::refObject, V8SpeechGrammar::derefObject, V8SpeechGrammar::trace, 0, 0, V8SpeechGrammar::preparePrototypeObject, V8SpeechGrammar::installConditionallyEnabledProperties, "SpeechGrammar", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static const V8DOMConfiguration::AccessorConfiguration V8SpeechGrammarAccessors[] = {
    {"src", SpeechGrammarV8Internal::srcAttributeGetterCallback, SpeechGrammarV8Internal::srcAttributeSetterCallback, 0, 0, 0, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"weight", SpeechGrammarV8Internal::weightAttributeGetterCallback, SpeechGrammarV8Internal::weightAttributeSetterCallback, 0, 0, 0, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8SpeechGrammarTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SpeechGrammar", v8::Local<v8::FunctionTemplate>(), V8SpeechGrammar::internalFieldCount,
        0, 0,
        V8SpeechGrammarAccessors, WTF_ARRAY_LENGTH(V8SpeechGrammarAccessors),
        0, 0);
...
v8::Local<v8::FunctionTemplate> V8SpeechGrammar::domTemplate(v8::Isolate* isolate)
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8SpeechGrammarTemplate);
}
...
void V8SpeechGrammar::refObject(ScriptWrappable* scriptWrappable)
{
}

void V8SpeechGrammar::derefObject(ScriptWrappable* scriptWrappable)
{
}
