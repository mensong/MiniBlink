...
#include "bindings/modules/v8/V8SyncRegistrationOptions.h"
...
#endif
const WrapperTypeInfo V8SyncManager::wrapperTypeInfo = { gin::kEmbedderBlink, V8SyncManager::domTemplate, V8SyncManager::refObject, V8SyncManager::derefObject, V8SyncManager::trace, 0, 0, V8SyncManager::preparePrototypeObject, V8SyncManager::installConditionallyEnabledProperties, "SyncManager", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void registerMethodPromise(const v8::FunctionCallbackInfo<v8::Value>& info, ExceptionState& exceptionState)
{
    ...
    SyncRegistrationOptions options;
    {
        ...
        V8SyncRegistrationOptions::toImpl(info.GetIsolate(), info[0], options, exceptionState);
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "getRegistration", "SyncManager", info.Holder(), info.GetIsolate());
...
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    SyncManagerV8Internal::getRegistrationMethod(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}
...
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    SyncManagerV8Internal::getRegistrationsMethod(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}
...
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    SyncManagerV8Internal::permissionStateMethod(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}
...
static const V8DOMConfiguration::MethodConfiguration V8SyncManagerMethods[] = {
    {"register", SyncManagerV8Internal::registerMethodCallback, 0, 0, V8DOMConfiguration::ExposedToAllScripts},
};
...
static void installV8SyncManagerTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::backgroundSyncV2Enabled()) {
        const V8DOMConfiguration::MethodConfiguration getRegistrationMethodConfiguration = {
            "getRegistration", SyncManagerV8Internal::getRegistrationMethodCallback, 0, 1, V8DOMConfiguration::ExposedToAllScripts,
        };
    ...
    if (RuntimeEnabledFeatures::backgroundSyncV2Enabled()) {
        const V8DOMConfiguration::MethodConfiguration getRegistrationsMethodConfiguration = {
            "getRegistrations", SyncManagerV8Internal::getRegistrationsMethodCallback, 0, 0, V8DOMConfiguration::ExposedToAllScripts,
        };
    ...
    if (RuntimeEnabledFeatures::backgroundSyncV2Enabled()) {
        const V8DOMConfiguration::MethodConfiguration permissionStateMethodConfiguration = {
            "permissionState", SyncManagerV8Internal::permissionStateMethodCallback, 0, 0, V8DOMConfiguration::ExposedToAllScripts,
        };
