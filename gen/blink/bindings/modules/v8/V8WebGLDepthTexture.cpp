...
#endif
const WrapperTypeInfo V8WebGLDepthTexture::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLDepthTexture::domTemplate, V8WebGLDepthTexture::refObject, V8WebGLDepthTexture::derefObject, V8WebGLDepthTexture::trace, 0, V8WebGLDepthTexture::visitDOMWrapper, V8WebGLDepthTexture::preparePrototypeObject, V8WebGLDepthTexture::installConditionallyEnabledProperties, "WebGLDepthTexture", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8WebGLDepthTextureTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "WebGLDepthTexture", v8::Local<v8::FunctionTemplate>(), V8WebGLDepthTexture::internalFieldCount,
        0, 0,
        0, 0,
        0, 0);
    ...
    static const V8DOMConfiguration::ConstantConfiguration V8WebGLDepthTextureConstants[] = {
        {"UNSIGNED_INT_24_8_WEBGL", 0x84FA, 0, 0, V8DOMConfiguration::ConstantTypeUnsignedLong},
    };
...
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8WebGLDepthTextureTemplate);
}
...
void V8WebGLDepthTexture::refObject(ScriptWrappable* scriptWrappable)
{
#if !ENABLE(OILPAN)
    scriptWrappable->toImpl<WebGLDepthTexture>()->ref();
#endif
}

void V8WebGLDepthTexture::derefObject(ScriptWrappable* scriptWrappable)
{
#if !ENABLE(OILPAN)
    scriptWrappable->toImpl<WebGLDepthTexture>()->deref();
#endif
}
