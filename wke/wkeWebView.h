...
struct CWebViewHandler {
    ...
    wkeResponseCallback netResponseCallback;
...
public:
    ...
    jsValue runJS(const wchar_t* script, bool isInClosure) override;
    jsValue runJS(const utf8* script, bool isInClosure) override;
    ...
    void onNetResponse(wkeResponseCallback callback, void* callbackParam);
